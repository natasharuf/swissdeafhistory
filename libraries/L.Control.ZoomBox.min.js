L.Control.ZoomBox = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    L.DomEvent.on(this._container, "dblclick", L.DomEvent.stop).on(this._container, "click", L.DomEvent.stop).on(this._container, "mousedown", L.DomEvent.stopPropagation).on(this._container, "click", function() {
